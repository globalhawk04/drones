...
I am going to take a break on the quad.  It is has become obvious that the way that I started this project ie trying to pivot existing code has led me down a circular drain rabbit hole of troubleshooting that I could follow or I can step back and start from scratch using drone_4 was a model to build off of.  It may also be that sourcing these parts is much more difficult that drones which is leading to another branch set of problems.  
